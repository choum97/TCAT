			...
			<div class="card">
				<div class="card-body row">
					...
					<div class="col-7">
					 ...
					 <div class="form-group">
               			 <label>시작일</label>
						<input type="date" class="form-control" value="<%=beginMonth%>-01" id="start_date" name="start_date" max="<%=now%>" readonly>
					</div>	
					 ...
					 <div class="form-group">	
						<label>종료일</label>
						<input type="date" class="form-control" value="<%=now%>" id="end_date" name="end_date" max="<%=now%>" readonly>
					</div>
